...
class MobilityServiceTest {
    ...
    void searchByArrivalDongCodeAppliesTimeAndDistrictFilters() {
        ...
        MobilityFilterRequest filterRequest = MobilityFilterRequest.builder()
                .minAvgTime(30.0)
                .maxAvgTime(60.0)
    ...
    void searchByArrivalDongCodeAppliesMonthlyRentPriceRangeFilter() {
        ...
        when(rentPriceService.getDetails(List.of("1121571000", "1162069500")))
                .thenReturn(List.of(
                        rentPriceDetail(
                                "1121571000",
                                "OFFICETEL",
    ...
    void searchByArrivalDongCodesAppliesEachTimeAndDistrictFilters() {
        ...
        when(mobilityRepository.findByArrivalDongIn(List.of(firstArrivalDong, secondArrivalDong)))
                .thenReturn(List.of(
                        ...
                        mobility(firstArrivalDong, districtExcludedDepartureDong, 500.0, 40.0),
    ...
    @Test
    @DisplayName("가격 필터와 거래 형태가 맞지 않으면 400 응답을 반환한다")
    void searchByArrivalDongCodeReturnsBadRequestWhenPriceFilterMismatchesContractType() {
        MobilityFilterRequest filterRequest = MobilityFilterRequest.builder()
                .contractType("SALE")
        ...
        assertThat(response.getMessage()).isEqualTo("매매 필터에는 전세/월세 가격 필터를 함께 사용할 수 없습니다.");
        assertThat(response.getData()).isNull();
    ...
    private AdminDongRentPriceDetailResponse rentPriceDetail(
        ...
        return new AdminDongRentPriceDetailResponse(
                ...
                true,
                null,
                List.of(new AdminDongRentPriceBuildingTypeResponse(
                        ...
                        monthlyRent == null ? new MonthlyRentDisplayValueResponse(null, null) : monthlyRent
                ))
        );
    }

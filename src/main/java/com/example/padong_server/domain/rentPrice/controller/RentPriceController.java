...
public class RentPriceController {
                                ...
                                array =
                                        @ArraySchema(
                                                schema =
                                                        @Schema(
                                                                implementation =
                                                                        AdminDongRentPriceSummaryResponse
                                                                                .class)),
                                examples =
                                        @ExampleObject(
                                                value =
                                            ...
                                            examples =
                                                    @ExampleObject(
                                                            value =
                                                                    ...
                                                                    """)))
                    @RequestBody
                    RentPriceSummaryRequest request) {
        return ResponseEntity.ok(
                rentPriceService.getSummaries(
                ...
                content =
                        @Content(
                                ...
                                schema =
                                        @Schema(
                                                implementation =
                                                        AdminDongRentPriceDetailResponse.class),
                                examples =
                                        @ExampleObject(
                                                value =
                                                        """
    ...
    public ResponseEntity<AdminDongRentPriceDetailResponse> getAdminDongDetail(
            @Parameter(description = "행정동 코드", example = "1168064000") @PathVariable
